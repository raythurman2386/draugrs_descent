...
class MainMenuScene(Scene):
    ...
    def load_ui_assets(self):
        ...
        button_start_y = self.panel_rect.top + config.get("ui", "main_menu", "buttons", "start_y_offset", default=100)
    ...
    def render(self):
        ...
        title_rect = title.get_rect(center=(screen_width // 2, self.panel_rect.top + title_y_offset))
