...
class TestGameScoring:
    ...
    def test_score_updates_on_enemy_death(self, game_scene):
        ...
        assert (
            game_scene.score_manager.current_score
            == initial_score + ScoreManager.ENEMY_DEFEAT_POINTS
        )
    ...
    def test_score_updates_on_powerup_collection(self, game_scene):
        ...
        assert (
            game_scene.score_manager.current_score
            == initial_score + ScoreManager.POWERUP_COLLECTED_POINTS
        )
    ...
    def test_high_score_persistence(self, game_scene, mocker):
        ...
        load_mock = mocker.patch.object(
            new_game.score_manager, "load_high_score", return_value=high_score
        )
